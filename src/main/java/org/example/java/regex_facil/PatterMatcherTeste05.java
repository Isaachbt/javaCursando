...
public class PatterMatcherTeste05 {
    public static void main(String[] args) {
        ...
        String regex = "([a-zA-Z0-9\\._-])+@([a-zA-Z])+\\.([a-zA-Z])";//se vc por aqui "ab" por exemplo ele vai procurar todos ab do texto
        String texto = "isaac@gmail.com, 123zeroTwo@hotmail.com, @$#goku@gmail.br, teste@gmail.com, hiro@gmail";//texto de exemplo
        String texto2 = "";
